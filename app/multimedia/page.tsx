...
export default async function MultimediaPage({
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Filters: ajustar top, z y fondo para que no se solape */}
      ...
      {/* Spacer: debe igualar la altura real del sticky (nav + filtros). Ajusta si es necesario */}
      <div aria-hidden />

      {/* Gallery Grid: añadir padding-top extra como respaldo */}
          ...
          {resources.length > 0 ? (
            ...
            <div className="text-center py-12">
              ...
              <p className="text-muted-foreground">
                Vuelve pronto para ver nuevas imágenes y videos
              </p>
            </div>
          )}
        </div>
